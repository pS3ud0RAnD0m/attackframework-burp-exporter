...
class TrafficMisgateExportOpenSearchIT {
    ...
    void misgateSuspect_indexesRequestWithoutBodyParamsOrExportMetadata() {
        ...
        List<Map<String, Object>> builtParameters =
                stringObjectMapList(requestDoc.get("parameters"));
        ...
        Object parameters = nestedMap(stored, "request").get("parameters");
        if (parameters != null) {
            assertThat(stringObjectMapList(parameters)).isEmpty();
        }
    }
