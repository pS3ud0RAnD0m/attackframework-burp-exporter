...
class LoggerPipelineIT {
    ...
    void externalSlf4j_logger_routesThroughUiAppender_toListenerBus() throws Exception {
        ...
        // UiAppender only forwards our package; third-party loggers are not forwarded to avoid UI flood.
        org.slf4j.Logger externalInOurPackage = LoggerFactory.getLogger("ai.anomalousvectors.tools.burp.utils.ExternalLog");
