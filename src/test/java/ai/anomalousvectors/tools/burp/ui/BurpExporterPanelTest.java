...
import static ai.anomalousvectors.tools.burp.ui.text.Tooltips.TOOLTIP_SHOW_DELAY_MS;
...
class BurpExporterPanelTest {
    ...
    void extensionUi_usesSharedTooltipShowDelay() throws Exception {
        ...
        try {
            ...
            SwingUtilities.invokeAndWait(() -> new BurpExporterPanel());
            SwingUtilities.invokeAndWait(() -> {
                ToolTipManager manager = ToolTipManager.sharedInstance();
