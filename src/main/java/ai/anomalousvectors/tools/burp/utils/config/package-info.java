 ...
 *
 * <p>Includes JSON mapping helpers ({@link ai.anomalousvectors.tools.burp.utils.config.ConfigJsonMapper}),
 ...
 * {@link ai.anomalousvectors.tools.burp.utils.FileUtil} to keep boundaries clear.</p>
 */
