...
public final class ExportShutdownStatus {
    ...
    /** Status while the final exporter stats snapshot is pushed before final validation. */
    public static String pushingFinalStatsMessage() {
        return PREFIX + "pushing final exporter stats …";
    }

    /** Status while final OpenSearch index counts are collected for the stop summary. */
    public static String collectingOpenSearchCountsMessage() {
        return PREFIX + "collecting final OpenSearch counts …";
    }
