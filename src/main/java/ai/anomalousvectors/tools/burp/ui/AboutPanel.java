...
public class AboutPanel extends JPanel {
    ...
    private static JPanel buildContent(String version) {
        ...
        JLabel header = new JLabel(ProductInfo.EXTENSION_NAME + " v" + version);
        ...
        panel.add(buildLinkRow("  " + ProductInfo.REPOSITORY_LABEL, ProductInfo.REPOSITORY_URL), "growx, wrap");
        panel.add(buildLinkRow("  " + ProductInfo.FRAMEWORK_OPENSEARCH_LABEL,
                ProductInfo.FRAMEWORK_OPENSEARCH_URL), "growx");
        return panel;
    }
