 ...
 * event wiring only; long-running actions are delegated to {@link ai.attackframework.tools.burp.ui.controller.ConfigController},
 * which coordinates background work and reports results through a small {@link
 * ai.attackframework.tools.burp.ui.controller.ConfigController.Ui} surface. The controller never touches Swing
